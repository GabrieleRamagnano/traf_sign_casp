...
main() {
    ...
    while read -r pddl_instance; do
        ...
        #for hor in 600 ; do
            ...
            echo $asp_facts | clingcon $asp_instance ./../../model/constants.lp ./../../model/instance_random.lp ./../../model/enc_conf.lp ./../../model/pddl_delta_sum_extra_bnd_minus.lp ./../../model/heu/doria_encoding.lp - --const horizon=$hor --const bound=0 --config=crafty --time-limit=600 --heuristic=Domain --q=1  >> $clingcon_output 2>/dev/null
